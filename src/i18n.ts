...
export const T: Record<Lang, Strings> = {
  zh: {
    ...
    table_search_placeholder: "搜尋學號、姓名、GitHub、Google 或 LINE",
    ...
    enroll_note: "已綁定 GitHub：{bound}／Google：{gbound}／LINE：{lbound}。匯入後，此課的綁定名單與 roster 匯出會縮到「選課∩已綁」。",
    ...
    confirm_delete_detail: "將刪除 {id} 的全域 GitHub／Google／LINE 帳號綁定，所有課程都會受影響；成績與選課資料不會刪除。",
  ...
  en: {
    ...
    table_search_placeholder: "Search student ID, name, GitHub, Google, or LINE",
    ...
    enroll_note: "Bound to GitHub: {bound} / Google: {gbound} / LINE: {lbound}. Once imported, this course's bindings list and roster export narrow to enrolled ∩ bound.",
    ...
    confirm_delete_detail: "This deletes {id}'s global GitHub/Google/LINE account binding and affects every course. Grades and enrollment data are kept.",
