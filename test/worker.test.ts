...
const testEnv: Env = {
  ...
  CS_AUTHORIZE_URL: "https://oauth.cs.nycu.edu.tw/oauth/authorize",
  CS_TOKEN_URL: "https://oauth.cs.nycu.edu.tw/oauth/token",
  CS_USERINFO_URL: "https://oauth.cs.nycu.edu.tw/oauth/userinfo",
  CS_SCOPE: "openid profile csid email",
  CS_CLIENT_ID: "cs_id",
  CS_CLIENT_SECRET: "cs_secret",
